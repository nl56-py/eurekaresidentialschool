...
import { adminCreateGalleryItem } from "../actions";
...
export default function AdminNewGalleryItemPage() {
  return (
    <>
      <div className="admin-topbar mb-8">
        ...
        <h1 className="text-3xl font-black text-[#10233f]">Add Gallery Photo</h1>
        <p className="text-slate-500 text-sm mt-1">Add a new photo to the school gallery under a specific category.</p>
      </div>

      <form action={adminCreateGalleryItem} className="bg-white rounded-lg border border-slate-200 shadow-sm p-8 max-w-[800px]">
        <div className="grid gap-6">
          ...
          <div>
            <ImageUploader
              name="cover_image"
              defaultValue="/images/school details.jpg"
