...
import { adminCreateBlog } from "../actions";
  ...
  return (
    <>
      <div className="admin-topbar mb-8">
        ...
        <h1 className="text-3xl font-black text-[#10233f]">Create New Blog</h1>
        <p className="text-slate-500 text-sm mt-1">Publish a new column or educational insight article.</p>
      </div>

      <form action={adminCreateBlog} className="bg-white rounded-lg border border-slate-200 shadow-sm p-8 max-w-[900px]">
