...
import { adminUpdateEvent } from "../actions";
  ...
  return (
    <>
      <div className="admin-topbar mb-8">
        ...
        <h1 className="text-3xl font-black text-[#10233f]">Edit Event</h1>
        <p className="text-slate-500 text-sm mt-1">Modify the existing event details below.</p>
      </div>

      <form action={adminUpdateEvent} className="bg-white rounded-lg border border-slate-200 shadow-sm p-8 max-w-[800px]">
